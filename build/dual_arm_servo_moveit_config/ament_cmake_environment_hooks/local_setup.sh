...
: ${AMENT_CURRENT_PREFIX:="/workspaces/challenge_ws/install/dual_arm_servo_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dual_arm_servo_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dual_arm_servo_moveit_config/environment/path.sh"
